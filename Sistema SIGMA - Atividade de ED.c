...
/* ************************ Função para exibir a listagem de alunos matriculados em uma classe ************************ */
int exibirAlunosPorClasse(tipoClasse *classe) {
    if (classe == NULL || classe->inicio == NULL) {
        printf("\nNenhum aluno matriculado nesta classe.\n");
        return 0;
    }

    printf("\n--- Alunos da Classe %s - Turma %c - Etapa %s ---\n", classe->serie, classe->turma, classe->etapa);
    tipoAluno *atual = classe->inicio; // Inicia no primeiro aluno da lista interna da classe
    while (atual != NULL) {
...
=======
        ...
        printf("\n 3 - Exibir todas as classes cadastradas no sistema");
         printf("\n 4 - Exibir listagem de alunos de uma classe"); // Opção adicionada
        printf("\n 5 - Excluir aluno de uma classe");
        printf("\n 6 - Excluir uma classe");
>>>>>>> Stashed changes
        printf("\n 0 - Encerar o SIGMA");
...
=======
            ...
            break;
             ...
             case 4: // Novo case criado para exibir alunos por classe
            printf("\nSelecione a classe para exibir os alunos:");
            printf("\nDigite a série: ");
            ...
            aux = pesqClasse(&listaClasses, serie, &turma, etapa); // turma agora é passado como ponteiro para char em pesqClasse

            if (aux != NULL) {
                exibirAlunosPorClasse(aux);
            } else {
